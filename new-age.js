            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response['status'] == 'success') {
                        ...
                        $('#response').show();
                        $('#final-error').hide();
   $('.response-text').html("<h3 style=color:green><strong>Application Submitted!</strong></h3> We have successfully received your enquiry for insulation grants. <h4><strong>Next steps</strong></h4> One of our approved energy assessor will call you within 36 hours to arrange free energy assessment for your property.<br> <h4><strong>Guarantee Work</strong></h4> Once your work is completed we will issue you guarantee for material, workmanship and installation, leaving you with peace of mind and a warmer home. <br>Please Note: Your data will be protected under the data protection act 1998.<br> ");
                    } else {
...
function validateFirstName() {
    ...
    if(firstNameVal == '') {
        ...
        firstNameError.text('First name should be more than 3 characters long');
        $(firstNameField).parent().addClass('has-error');
        firstNameError.show();
        return false;
    } else {
...
function validateLastName() {
    ...
    if(lastNameVal == '') {
        ...
        lastNameError.text('Last name should be more than 3 characters long');
        $(lastNameField).parent().addClass('has-error');
        lastNameError.show();
        return false;
    } else {
